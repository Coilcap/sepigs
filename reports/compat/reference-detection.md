...
- Generated: 2026-06-28T17:16:02.488Z
- Platform: darwin
- Architecture: arm64
...
| sing-box | available | sing-box | available | `/opt/homebrew/bin/sing-box version` | sing-box version 1.13.14 Environment: go1.26.4 darwin/arm64 Tags: with_gvisor,with_quic,with_dhcp,with_wireguard,with_utls,with_acme,with_clash_api,with_tailscale,with_ccm,with_ocm,with_naive_outbound,badlinkname,tfogo_checklinkname0 CGO: enabled | `brew install sing-box` |
| xray | available | xray | available | `/opt/homebrew/bin/xray version` | Xray 26.3.27 (Xray, Penetrates Everything.) Custom (go1.26.1 darwin/arm64) A unified platform for anti-censorship. | `brew install xray` |
