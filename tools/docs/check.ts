...
function checkRequiredFiles(allFiles: readonly string[]): void {
  ...
  const required = [
    ...
    "docs/v0.2.0-beta-release-checklist.md",
    "docs/v0.2.0-beta-security-summary.md",
    "docs/transactional-reload-design.md",
    "docs/reload-current-state-audit.md",
    "docs/transactional-reload-design-v0.3.0.md",
    "docs/reload-risk-matrix.md",
    "docs/reload-observability.md",
    "docs/soak-24h-v0.2.0-beta-report.md",
    "docs/soak-v0.2.0-beta-report.md",
    "docs/release-v0.2.0-beta-artifacts.md",
    "release-notes.md",
    "release-notes-v0.2.0-beta.md",
    "verification/mihomo.md",
    "verification/chrome-system.md",
    "verification/clash-verge.md",
